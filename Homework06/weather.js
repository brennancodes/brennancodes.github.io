...
//in the emptyWeather function, we need to empty all text content and remove all appended/prepended elements, then place the function at the start of the callWeather and callForecast functions.